...
public class PlayerRequesterInstruction extends BaseDeadlineInstruction {
    ...
    public String execute() {
        String slaveInfo = DeadlineProvider.get().getDC().getSlavesQueries().getSlaveInfo(AfterburnerSlaveApp.get().getMachineName());
        ...
        return plugInfo.has("PlayerRequester") ? plugInfo.get("PlayerRequester").getAsString() : AfterburnerSlaveApp.get().getMachineName();
    }
}
